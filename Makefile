...
TEST_BINS = test_circ_queue test_bst test_search test_hash_func \
            ...
            test_dijkstra test_bellman_ford test_bfs test_dfs test_topological_sort test_benchmark test_scc test_ford_fulkerson test_edmonds_karp test_dinic test_bipartite_matching test_hopcroft_karp test_eulerian_path test_min_max_heap
...
test_min_max_heap: $(TEST_DIR)/test_min_max_heap$(EXE)
	$(TEST_DIR)/test_min_max_heap$(EXE)
$(TEST_DIR)/test_min_max_heap$(EXE): $(OBJS) tests/advanced_heaps/test_min_max_heap.c
	@$(call MKDIR_P,$(TEST_DIR))
	$(CC) $(CFLAGS) $^ -o $@ $(LDFLAGS)
